...
namespace Ghiran_Ionut_Lab8.Models
{
    public class BookCategoriesPageModel:PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ghiran_Ionut_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ghiran_Ionut_Lab8Context context,
